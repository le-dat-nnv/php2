...
<div class="p-3 py-5 bg-white shadow rounded mt-5 ms-2 " style="width: 855px">
    ...
    <form action="index.php?url=update_rooms" method="POST" enctype="multipart/form-data">
        <div class="row mt-2">
            <div class="col-md-6"><input type="number" name="id" class="form-control" value="<?php echo $sua_rooms['id_room'] ?>" ></div>
            <div class="col-md-6"><input type="text" name="ma_rooms" class="form-control" placeholder="name service" value="<?= $ma_rooms ?>"></div>
        </div>
        <div class="row mt-3">
        ...
        <div class="row mt-3">
            ...
            <img class="w-50" src="<?php echo $img_room ?>" alt="Chưa có ảnh"/>
        </div>
        <div class="mt-3 text-right">
            <input class="btn btn-primary profile-button" type="submit" name="btn"><input class="btn btn-primary profile-button ms-2" type="reset" value="nhập lại"></div>
    </form>
</div>